...
from .views import (
    ...
    AdminAllocationViewSet, AdminSaleViewSet, AdminCustomerViewSet
)
...
router.register(r'sales', AdminSaleViewSet, basename='admin-sale')
router.register(r'customers', AdminCustomerViewSet, basename='admin-customer')
